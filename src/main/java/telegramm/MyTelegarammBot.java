...
import telegramm.commands.HelpCommand;
import telegramm.commands.StartCommand;

import java.util.concurrent.TimeUnit;

public class MyTelegarammBot extends TelegramLongPollingCommandBot {
    public static final String BOT_TOKEN= "5694771948:AAHSf7WtdUU_oSoeOvOfqfomRlLHVogJ4-g";
    public static final String BOT_USERNAME= "Pomodorou_bot";
    public static final int WORK = 25;
    public static final int BREAK = 5;
    public static String chatId;
    public MyTelegarammBot() throws TelegramApiException {
